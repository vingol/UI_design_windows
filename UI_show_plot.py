...
class Ui_MainWindow_show_plot(object):
    def setupUi(self, MainWindow):
        ...
        self.dateTimeEdit_2 = QtWidgets.QDateTimeEdit(QDateTime.currentDateTime(),self.widget2)
        ...
        self.dateTimeEdit = QtWidgets.QDateTimeEdit(QDateTime.currentDateTime(),self.widget2)
